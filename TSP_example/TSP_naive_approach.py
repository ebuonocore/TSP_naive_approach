...
def create_cost_table(cities: list[str]) -> dict[str, dict[str, float | None]]:
    ...
    """
    # Initialization of the cost table
    ...
    # Populate the city location table
    print("Populate the city location table.")
    for city in cities:
        city_locations[city] = get_city_coord(city)
    ...
    for j in range(len(cities)):
        ...
        for i in range(j, len(cities)):
            ...
            if city1 != city2:
                distance = get_distance_between_cities(loc1, loc2)
